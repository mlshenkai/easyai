...
class MusicAVQAMultiModelDataset(BaseMultiModelDataset):
    def __init__(self, **kwargs):
        ...
        self.annotation = [
            ann for ann in self.annotation if ann["video_id"] in self.sample_ids
        ]
    ...
    def __getitem__(self, index):
        ...
        question = (
            ...
            .replace("<Object>", "{}")
            .format(*ast.literal_eval(ann["templ_values"]))
        )
...
class MusicAVQAInstructDataset(MusicAVQAMultiModelDataset):
    def __getitem__(self, index):
