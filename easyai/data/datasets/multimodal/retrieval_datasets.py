...
class RetrievalMultiModelDataset(BaseMultiModelDataset, __DisplMixin):
...
class RetrievalEvalMultiModelDataset(BaseMultiModelDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
...
class VideoRetrievalMultiModelDataset(BaseMultiModelDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
...
class VideoRetrievalEvalMultiModelDataset(BaseMultiModelDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
        vis_root (string): Root directory of videos.
        ann_root (string): directory to store the annotation file
