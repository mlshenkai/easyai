...
class VATEXCaptionMultiModelDataset(BaseMultiModelDataset):
    def __init__(self, **kwargs):
        ...
        self.annotation = [
            ...
            if x["video"] not in seen and not seen.add(x["video"])
        ]
...
class VATEXCaptionEvalDataset(VATEXCaptionMultiModelDataset):
    def __getitem__(self, index):
...
class VATEXCaptionInstuctDataset(VATEXCaptionMultiModelDataset):
    def __getitem__(self, index):
        data = super().__getitem__(index)
        if data != None:
