...
from easyai.data.datasets.multimodal.object3d_captioning_datasets import Object3DCaptionMultiModelDataset


class ObjaverseQADataset(Object3DCaptionMultiModelDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.add_binary and random.randint(0, 10) < 3:
            ...
            if not yes_answer:
                caption_index = random.choice(
                    list(set(range(len(self.annotation))).difference(set([index])))
                )
