...
class SNLIVisualEntialmentDataset(MultimodalClassificationMultiModelDataset, __DisplMixin):
...
class SNLIVisualEntialmentInstructDataset(SNLIVisualEntialmentDataset, __DisplMixin):
    ...
    def __getitem__(self, index):
        ...
        if data != None:
            data["prompt"] = self.text_processor(
                "based on the given the image is {} true?"
            )
